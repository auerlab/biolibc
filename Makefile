...
OBJS    = overlap.o vcf.o sam.o bed.o gff.o fasta.o fastq.o \
...
fastq2tsv: fastq2tsv.c ${SLIB}
	${CC} ${CFLAGS} -o fastq2tsv fastq2tsv.c ${SLIB} \
		 -L${LOCALBASE}/lib -lxtend ${LDFLAGS}
...
clean:
	rm -f ${BINS} *.o *.a lib*.so.* lib*.dylib *.nr
...
common-install:
	...
	${INSTALL} -m 0555 ${BINS} ${DESTDIR}${PREFIX}/bin
